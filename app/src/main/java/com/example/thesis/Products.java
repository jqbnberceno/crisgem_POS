...
public class Products extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button drinksButton = findViewById(R.id.drinksBtn);
        ...
        reserve.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Products.this, OrderList.class);
...
// Set an OnClickListener to the drinks button
        drinksButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Start the DrinksActivity
                Intent intent = new Intent(Products.this, ReservedOrders.class);
                startActivity(intent);
            }
        });
        ...
        pesoO.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(Products.this, "Invalid cash amount", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        totalBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (buttonTextViewMap.isEmpty()) {
                    Toast.makeText(Products.this, "No Orders Added", Toast.LENGTH_SHORT).show();
                    return;
                }

                String cashReceivedStr = cashReceivedTextView.getText().toString().trim();
                if (TextUtils.isEmpty(cashReceivedStr)) {
                    Toast.makeText(Products.this, "Please enter the cash amount", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                builder.setTitle("Order Confirmation")
                        .setMessage(confirmationMessage.toString() + "\nCash Received: ₱" + cashReceivedTextView.getText().toString() + "\nChange: ₱" + (Double.parseDouble(cashReceivedTextView.getText().toString()) - orderTotalSum) + "\nTotal: ₱" + orderTotalSum)
                        .setPositiveButton("Confirm", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                if (cashReceived < orderTotalSum) {
                                    Toast.makeText(Products.this, "Insufficient cash received", Toast.LENGTH_SHORT).show();
                                    return;
                                }
                                ...
                                DatabaseReference orderTotalRef = databaseReference.child("orders")
                                        .child(dayOrdersRef)
                                        .child("orderTotalSum");
                                orderTotalRef.addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        ...
                                        if (dayOrdersRef != null && timeOrdersRef != null) {
                                            DatabaseReference dayOrdersReference = databaseReference.child("orders").child(dayOrdersRef);
                                            ...
                                            Toast.makeText(Products.this, "Failed to place the order. Please try again.", Toast.LENGTH_SHORT).show();
                                        }

                                        Toast.makeText(Products.this, "Order placed successfully!", Toast.LENGTH_SHORT).show();
                                    ...
                                    public void onCancelled(@NonNull DatabaseError databaseError) {
                                        ...
                                        Toast.makeText(Products.this, "Failed to place the order. DB", Toast.LENGTH_SHORT).show();
                                    }
                                });
                            }
                        })
